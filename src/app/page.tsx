  ...
  return (
    <>
      <NavBar>
        ...
        {!menuOpen && (
          <NavbarContent className={menuOpen ? "hidden" : ""}>
      ...
      {menuOpen && (
        <MobileMenu>
          <NavbarTitle onClick={toggleMenu}>Home</NavbarTitle>
          <NavbarTitle onClick={toggleMenu}>Projetos</NavbarTitle>
          <NavbarTitle onClick={toggleMenu}>Sobre</NavbarTitle>
          <NavbarTitle onClick={toggleMenu}>Contato</NavbarTitle>
        </MobileMenu>
      )}
      <ResponsiveContainer>
        <Container>
          <Content>
            ...
            <DescriptionDiv>
              <ContentDescription>
                ...
                designs no Figma e publicando aplicativos nas lojas Google Play
                e App Store. Também já atuei como Scrum Master em projetos
                mobile.
              </ContentDescription>
            </DescriptionDiv>
            <QuickAccess>
